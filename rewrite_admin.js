...
if (startIndex !== -1 && endIndex !== -1) {
 ...
 setSiigoLogs([]);
 const addLog = (msg) => setSiigoLogs(prev => [...prev, \\: \\]);
 ...
 <strong>Ref: {p.referencia}</strong> - {p.nombre} (\ COP | Stock: {p.stock})
 </div>
 ))}
 ...
 <span>Precio: \ ➔ <strong>\</strong></span>
 ...
 addLog(\❌ Error aplicando cambios: \\);
